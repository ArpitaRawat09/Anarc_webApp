...
const Footer = () => {
  ...
  return (
    <footer
      data-scroll-section
      className="bg-black text-gray-300 py-16 px-6 border-t border-gray-800"
    >
      <motion.div
      ...
      >
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          {/* Brand Section */}
          <motion.div variants={itemVariants} className="lg:col-span-2" data-scroll data-scroll-speed="1">
            <motion.h2
          ...
          {/* Navigation Links */}
          <motion.div variants={itemVariants} data-scroll data-scroll-speed="0.8">
            ...
            <ul className="space-y-3 text-md">
              {["Home", "Products", "Gallery", "About", "Contact", "Support"].map((item) => (
          ...
          {/* Social Media */}
          <motion.div variants={itemVariants} data-scroll data-scroll-speed="1.2">
            <h3 className="text-white text-xl font-semibold mb-6 relative">
              Connect
